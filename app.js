...
const IMAGES = {
  ...
  // Missing image keys referenced in RECIPES
  fried_plantain_egg:             'images/fried_plantain_egg.jpeg',
  boiled_plantain_eggsauce:       'images/boiled_plantain_eggsauce.jpeg',
  beans_porridge_fried_plantain:  'images/beans_porridge_fried_plantain.jpeg',
  afang_soup:                     'images/afang_soup.jpeg',
  ofada_rice_ayamase:             'images/ofada_rice_ayamase.jpeg',
  amala_ewedu:                    'images/amala_ewedu.jpeg',
  pounded_yam_egusi:              'images/pounded_yam_egusi.jpeg',
};
...
const MARKET_ITEMS = [
  { name:'Tomatoes',       emoji:'🍅', unitPrice:2000, unit:'basket/1kg',  priority:'high',   category:'Vegetables' },
  { name:'Pepper',         emoji:'🌶️', unitPrice:5000,  unit:'1kg',         priority:'high',   category:'Vegetables' },
  { name:'Onion',          emoji:'🧅', unitPrice:3000,  unit:'1kg',  priority:'high',   category:'Vegetables' },
  { name:'Rice',           emoji:'🍚', unitPrice:1500, unit:'1kg',         priority:'high',   category:'Grains' },
  { name:'Garri',          emoji:'🥣', unitPrice:500, unit:'1kg',         priority:'high',   category:'Grains' },
  { name:'Beans',          emoji:'🫘', unitPrice:1000, unit:'1kg',         priority:'high',   category:'Grains' },
  { name:'Yam',            emoji:'🍠', unitPrice:3000, unit:'1 tuber',     priority:'medium', category:'Grains' },
  { name:'Plantain',       emoji:'🍌', unitPrice:1000, unit:'bunch (2–3)', priority:'medium', category:'Grains' },
  { name:'Bread',          emoji:'🍞', unitPrice:2000, unit:'loaf',        priority:'medium', category:'Grains' },
  { name:'Indomie',        emoji:'🍜', unitPrice:300,  unit:'pack (75g)',        priority:'low',    category:'Grains' },
  { name:'Spaghetti',      emoji:'🍝', unitPrice:1500,  unit:'500g',        priority:'low',    category:'Grains' },
  { name:'Chicken',        emoji:'🍗', unitPrice:7000, unit:'1kg',         priority:'medium', category:'Proteins' },
  { name:'Beef',           emoji:'🥩', unitPrice:6000, unit:'1kg',         priority:'medium', category:'Proteins' },
  { name:'Goat Meat',      emoji:'🍖', unitPrice:6500, unit:'1kg',         priority:'low',    category:'Proteins' },
  { name:'Fish (Tilapia)', emoji:'🐟', unitPrice:4000, unit:'medium fish', priority:'medium', category:'Proteins' },
  { name:'Catfish',        emoji:'🐠', unitPrice:5000, unit:'1kg',         priority:'low',    category:'Proteins' },
  { name:'Eggs',           emoji:'🥚', unitPrice:3500, unit:'½ crate (15)', priority:'high',   category:'Proteins' },
  { name:'Smoked Fish',    emoji:'🐡', unitPrice:3000, unit:'medium',      priority:'medium', category:'Proteins' },
  { name:'Stockfish',      emoji:'🦴', unitPrice:1500, unit:'medium',      priority:'medium', category:'Proteins' },
  { name:'Turkey',         emoji:'🦃', unitPrice:4000, unit:'½kg',         priority:'low',    category:'Proteins' },
  { name:'Cabbage',        emoji:'🥬', unitPrice:1300,  unit:'small head',  priority:'medium', category:'Vegetables' },
  { name:'Carrots',        emoji:'🥕', unitPrice:500,  unit:'3 medium',    priority:'medium', category:'Vegetables' },
  { name:'Garden Egg',     emoji:'🍆', unitPrice:500,  unit:'bunch',       priority:'low',    category:'Vegetables' },
  { name:'Spinach/Tete',   emoji:'🌿', unitPrice:500,  unit:'bunch',       priority:'medium', category:'Vegetables' },
  { name:'Ugwu',           emoji:'🌱', unitPrice:500,  unit:'bunch',       priority:'medium', category:'Vegetables' },
  { name:'Okra',           emoji:'🫑', unitPrice:500,  unit:'250g',        priority:'medium', category:'Vegetables' },
  { name:'Pumpkin Leaf',   emoji:'🍃', unitPrice:500,  unit:'bunch',       priority:'low',    category:'Vegetables' },
  { name:'Palm Oil',       emoji:'🫙', unitPrice:3000, unit:'1 litre',     priority:'high',   category:'Oils' },
  { name:'Vegetable Oil',  emoji:'🛢️', unitPrice:3500, unit:'1 litre',     priority:'high',   category:'Oils' },
  { name:'Ground Crayfish',emoji:'🦐', unitPrice:2000, unit:'small cup',   priority:'medium', category:'Seasonings' },
  { name:'Seasoning Cubes',emoji:'🧂', unitPrice:1500, unit:'pack of 12',  priority:'high',   category:'Seasonings' },
  { name:'Egusi',          emoji:'🥜', unitPrice:5000, unit:'500g',        priority:'medium', category:'Seasonings' },
  { name:'Ogbono',         emoji:'🌰', unitPrice:6000, unit:'200g',        priority:'low',    category:'Seasonings' },
  { name:'Locust Beans',   emoji:'🫘', unitPrice:300,  unit:'sachet',      priority:'low',    category:'Seasonings' },
  { name:'Milk (Tin)',     emoji:'🥛', unitPrice:8000,  unit:'1kg',         priority:'low',    category:'Others' },
  { name:'Sugar',          emoji:'🍬', unitPrice:1000, unit:'500g',        priority:'medium', category:'Others' },
  { name:'Salt',           emoji:'🧂', unitPrice:500,  unit:'sachet',      priority:'high',   category:'Others' },
  { name:'Coconut Milk',   emoji:'🥥', unitPrice:3500, unit:'tin',         priority:'low',    category:'Others' },
];
...
const HEALTHY_RECIPES = [
  ...
  // ── Breakfast additions ──
  {
    id:'h19', name:'Oats + Greek Yogurt + Banana', emoji:'🥣', category:'Healthy & Diet',
    dietTags:['weight-loss','high-fiber','high-protein','low-calorie'],
    calories:310, protein:14, carbs:48, fat:6, servings:1, cookTime:5, difficulty:'Easy',
    cost:2000,
    ingredients:['1 cup rolled oats (₦400)','½ cup Greek yogurt (₦600)','1 banana sliced (₦300)','1 tsp honey (₦200)'],
    steps:[
      'Cook oats with water or milk for 3–4 minutes until creamy.',
      'Pour into a bowl. Top with Greek yogurt.',
      'Slice banana over the top. Drizzle honey.',
      'Serve immediately. High protein, high fiber, naturally sweet.',
    ],
    healthNote:'Greek yogurt adds 8–10g protein per serving. Oats + banana = sustained energy all morning with no sugar crash.',
  },
  {
    id:'h20', name:'Low-Sugar Pap + Boiled Eggs', emoji:'🥚', category:'Healthy & Diet',
    dietTags:['weight-loss','high-protein','diabetic','low-calorie'],
    calories:240, protein:16, carbs:28, fat:7, servings:1, cookTime:10, difficulty:'Easy',
    cost:1200,
    ingredients:['3 tbsp corn pap powder (₦400)','hot water','2 boiled eggs (₦260)','pinch of salt','no added sugar'],
    steps:[
      'Mix pap powder with a little cold water into a smooth paste.',
      'Pour boiling water slowly while stirring until desired consistency.',
      'Do NOT add sugar — the pap is naturally mild.',
      'Serve with 2 hard-boiled eggs for a high-protein breakfast.',
    ],
    healthNote:'Removing sugar from pap drops the calorie count dramatically. Eggs provide complete protein and keep you full until lunch.',
  },
  {
    id:'h21', name:'Sweet Potato + Scrambled Eggs', emoji:'🍠', category:'Healthy & Diet',
    dietTags:['weight-loss','high-protein','high-fiber','diabetic'],
    calories:290, protein:14, carbs:38, fat:9, servings:2, cookTime:25, difficulty:'Easy',
    cost:2500,
    ingredients:['2 medium sweet potatoes (₦1,500)','3 eggs (₦380)','1 tomato (₦200)','onion','1 tsp vegetable oil','salt, pepper'],
    steps:[
      'Boil sweet potatoes until soft, about 20 minutes. Slice.',
      'Heat oil in pan. Sauté onion and tomato for 2 minutes.',
      'Add eggs and scramble gently. Season with salt and pepper.',
      'Serve scrambled eggs alongside sweet potato slices.',
    ],
    healthNote:'Sweet potato has a lower glycemic index than yam and is rich in beta-carotene. A perfectly balanced plate.',
  },
  {
    id:'h22', name:'Greek Yogurt + Honey + Groundnuts', emoji:'🫙', category:'Healthy & Diet',
    dietTags:['high-protein','weight-loss','low-calorie'],
    calories:220, protein:12, carbs:18, fat:9, servings:1, cookTime:2, difficulty:'Easy',
    cost:1200,
    ingredients:['1 cup Greek yogurt (₦700)','1 tsp honey (₦200)','small handful roasted groundnuts (₦200)'],
    steps:[
      'Spoon Greek yogurt into a bowl.',
      'Drizzle honey on top.',
      'Scatter roasted groundnuts. Serve immediately.',
      'Optional: add banana or apple slices for more fiber.',
    ],
    healthNote:'Greek yogurt has 2× the protein of regular yogurt. This 3-ingredient breakfast takes 2 minutes and keeps hunger away for hours.',
  },
  {
    id:'h23', name:'Whole Wheat Bread + Avocado + Egg', emoji:'🍞', category:'Healthy & Diet',
    dietTags:['high-protein','high-fiber','weight-loss'],
    calories:340, protein:16, carbs:32, fat:16, servings:1, cookTime:10, difficulty:'Easy',
    cost:2500,
    ingredients:['2 slices whole wheat bread (₦600)','½ avocado (₦800)','1 boiled or poached egg (₦130)','salt, pepper, lemon juice'],
    steps:[
      'Toast whole wheat bread.',
      'Mash avocado with salt, pepper, and a squeeze of lemon.',
      'Spread avocado on toast.',
      'Top with a sliced boiled egg. Serve immediately.',
    ],
    healthNote:'Avocado provides healthy monounsaturated fat. Whole wheat bread has 3× the fiber of white bread. Egg adds complete protein.',
  },
  {
    id:'h24', name:'Boiled Corn + Coconut Slices', emoji:'🌽', category:'Healthy & Diet',
    dietTags:['high-fiber','vegetarian','low-calorie','weight-loss'],
    calories:210, protein:5, carbs:38, fat:7, servings:1, cookTime:30, difficulty:'Easy',
    cost:800,
    ingredients:['1 fresh corn cob (₦500)','coconut slices (₦300)','salt optional'],
    steps:[
      'Boil corn in salted water for 25–30 minutes until tender.',
      'Crack open fresh coconut and slice into small pieces.',
      'Eat together — the coconut fat slows sugar release from the corn.',
      'Season corn with salt if desired. No butter needed.',
    ],
    healthNote:'A classic Nigerian street-food combo that is actually healthy. High fiber, naturally satisfying, and very affordable.',
  },
  {
    id:'h25', name:'Air-Fried Akara + Pap (Low Oil)', emoji:'🫓', category:'Healthy & Diet',
    dietTags:['high-protein','high-fiber','weight-loss','low-calorie'],
    calories:250, protein:16, carbs:30, fat:6, servings:2, cookTime:30, difficulty:'Medium',
    cost:2000,
    ingredients:['2 cups peeled black-eyed beans (₦1,400)','1 onion','pepper','salt','2 tsp vegetable oil (air fry method)','3 tbsp corn pap powder (₦400)'],
    steps:[
      'Blend beans with onion, pepper, and minimal water into thick batter.',
      'Whisk vigorously for 5 minutes. Season with salt.',
      'Air fry or pan-fry with just 2 tsp oil at low heat — flip carefully.',
      'Cook pap without sugar. Serve akara alongside.',
    ],
    healthNote:'Air-frying akara cuts the fat by 60% compared to deep frying. Still crispy, still delicious.',
  },
  {
    id:'h26', name:'Plantain Porridge (Light Oil)', emoji:'🍌', category:'Healthy & Diet',
    dietTags:['weight-loss','high-fiber','diabetic'],
    calories:260, protein:4, carbs:55, fat:5, servings:2, cookTime:25, difficulty:'Easy',
    cost:2000,
    ingredients:['2 unripe plantains (₦800)','1 tsp palm oil (minimal)','peppers','onion','spinach (₦400)','seasoning','salt'],
    steps:[
      'Peel and dice unripe plantains. Add to pot with water.',
      'Add just 1 tsp palm oil, peppers, onion, seasoning.',
      'Cook on medium heat 20 minutes until soft.',
      'Add spinach in last 2 minutes. Mash some plantain to thicken.',
    ],
    healthNote:'Unripe plantain has a lower glycemic index than ripe. Using 1 tsp oil instead of 3 tbsp saves ~300 calories per pot.',
  },
  {
    id:'h27', name:'Whole Wheat Pancakes + Yogurt', emoji:'🥞', category:'Healthy & Diet',
    dietTags:['high-fiber','weight-loss','high-protein'],
    calories:280, protein:14, carbs:36, fat:8, servings:2, cookTime:20, difficulty:'Easy',
    cost:2000,
    ingredients:['1 cup whole wheat flour (₦400)','1 egg (₦130)','½ cup milk (₦300)','1 tsp baking powder','½ banana mashed (₦150)','Greek yogurt to serve (₦600)'],
    steps:[
      'Mix flour, baking powder, egg, milk, and mashed banana into smooth batter.',
      'Heat non-stick pan with minimal oil.',
      'Pour ladles of batter. Cook 2 minutes per side until golden.',
      'Serve with Greek yogurt instead of syrup.',
    ],
    healthNote:'Banana replaces sugar naturally. Whole wheat flour adds fiber. Greek yogurt topping adds protein instead of empty calories.',
  },

  // ── Lunch additions ──
  {
    id:'h28', name:'Jollof Rice (Controlled Portion) + Grilled Chicken', emoji:'🍚', category:'Healthy & Diet',
    dietTags:['weight-loss','high-protein'],
    calories:420, protein:32, carbs:45, fat:10, servings:1, cookTime:60, difficulty:'Medium',
    cost:4500,
    ingredients:['½ cup dry rice per person (₦600)','tomatoes, peppers, onion (₦1,000)','1 tbsp vegetable oil (₦150)','200g chicken breast (₦960)','seasoning, thyme, curry, salt'],
    steps:[
      'Cook jollof rice as normal but use only 1 tbsp oil and a small rice portion.',
      'Season chicken breast with herbs and grill — no frying.',
      'Serve ½ cup cooked rice alongside grilled chicken.',
      'Add cucumber or salad on the side to fill the plate.',
    ],
    healthNote:'Portion control is the key. ½ cup rice + grilled chicken = a satisfying, balanced meal under 500 calories.',
  },
  {
    id:'h29', name:'Brown Rice + Beans + Grilled Fish', emoji:'🍚', category:'Healthy & Diet',
    dietTags:['high-protein','high-fiber','diabetic','weight-loss'],
    calories:380, protein:28, carbs:50, fat:7, servings:2, cookTime:60, difficulty:'Easy',
    cost:5000,
    ingredients:['½ cup brown rice per person (₦700)','1 cup cooked beans (₦800)','2 medium fish (tilapia) (₦2,000)','lemon, pepper soup spice, salt','1 tsp vegetable oil'],
    steps:[
      'Cook brown rice (soak 30 mins first — it takes longer than white rice).',
      'Season fish with spice, salt, lemon. Grill 12 minutes.',
      'Heat beans separately with minimal seasoning.',
      'Plate: rice + beans + grilled fish. Complete meal.',
    ],
    healthNote:'Brown rice + beans = complete amino acid profile. Fish adds lean omega-3 protein. This meal keeps blood sugar stable for hours.',
  },
  {
    id:'h30', name:'Wheat Swallow + Efo Riro', emoji:'🌾', category:'Healthy & Diet',
    dietTags:['high-fiber','high-protein','weight-loss'],
    calories:320, protein:24, carbs:38, fat:9, servings:2, cookTime:35, difficulty:'Easy',
    cost:4000,
    ingredients:['wheat meal flour 100g (₦600)','500g fresh spinach (₦500)','200g assorted meat (₦2,000)','1 tbsp palm oil (reduced)','peppers, onion, crayfish, seasoning'],
    steps:[
      'Boil water and stir in wheat meal to make a smooth swallow. Use a small portion.',
      'Cook efo riro: fry peppers in 1 tbsp palm oil, add meat, crayfish, seasoning.',
      'Add spinach last. Cook 3 minutes only — keep it green.',
      'Serve a small swallow ball with generous efo riro.',
    ],
    healthNote:'Wheat meal has more fiber than eba or semovita. Efo riro is one of the most nutritious Nigerian soups. A power combination.',
  },
  {
    id:'h31', name:'Grilled Tilapia + Cucumber Salad', emoji:'🐟', category:'Healthy & Diet',
    dietTags:['weight-loss','high-protein','low-calorie','diabetic','keto'],
    calories:220, protein:32, carbs:8, fat:7, servings:2, cookTime:20, difficulty:'Easy',
    cost:4500,
    ingredients:['2 medium tilapia (₦3,000)','cucumber (₦500)','tomatoes (₦400)','lemon juice','onion rings','pepper soup spice','salt','1 tsp vegetable oil'],
    steps:[
      'Score fish. Season with pepper soup spice, salt, lemon. Grill 12–15 minutes.',
      'Slice cucumber, tomatoes, and onion rings.',
      'Toss salad with lemon juice, salt, and a drizzle of oil.',
      'Serve grilled fish with salad on the side.',
    ],
    healthNote:'Under 250 calories. Zero starchy carbs. Perfect weight-loss lunch — high protein, high water content, very filling.',
  },
  {
    id:'h32', name:'Garden Egg + Fish Stew', emoji:'🍆', category:'Healthy & Diet',
    dietTags:['low-calorie','weight-loss','diabetic','vegetarian'],
    calories:180, protein:18, carbs:12, fat:7, servings:2, cookTime:25, difficulty:'Easy',
    cost:3000,
    ingredients:['6 garden eggs (₦600)','200g smoked or grilled fish (₦1,500)','tomatoes, peppers, onion (₦600)','1 tsp palm oil','crayfish, seasoning, salt'],
    steps:[
      'Boil or steam garden eggs until soft. Slice.',
      'Make light stew: blend and fry tomatoes, peppers in 1 tsp oil.',
      'Add fish, crayfish, seasoning. Cook 8 minutes.',
      'Serve stew over garden egg slices — no rice, no swallow needed.',
    ],
    healthNote:'Garden egg is one of the lowest-calorie Nigerian vegetables. High antioxidants, zero fat. A truly clean meal.',
  },
  {
    id:'h33', name:'Eba (Small) + Bitter Leaf Soup', emoji:'🫓', category:'Healthy & Diet',
    dietTags:['weight-loss','high-fiber'],
    calories:290, protein:20, carbs:32, fat:10, servings:1, cookTime:35, difficulty:'Easy',
    cost:3500,
    ingredients:['50g garri (small eba) (₦150)','bitter leaf 200g (₦400)','assorted meat 150g (₦1,500)','1 tbsp palm oil','crayfish, seasoning, salt, stockfish (₦1,000)'],
    steps:[
      'Make eba from just 50g garri — a small golf-ball-sized portion.',
      'Cook bitter leaf soup: wash leaf well, cook with meat, stockfish, 1 tbsp oil, crayfish.',
      'Season and simmer 20 minutes.',
      'Serve small eba with generous soup.',
    ],
    healthNote:'The key is a small eba. Bitter leaf is rich in vitamins and helps lower blood sugar. Let the soup be generous — not the swallow.',
  },
  {
    id:'h34', name:'Amala (Small) + Ewedu + Grilled Fish', emoji:'🌿', category:'Healthy & Diet',
    dietTags:['high-fiber','weight-loss','high-protein'],
    calories:300, protein:26, carbs:30, fat:8, servings:1, cookTime:30, difficulty:'Easy',
    cost:4000,
    ingredients:['60g elubo plantain flour (₦400)','jute leaves ewedu 200g (₦500)','1 medium grilled fish (₦1,500)','1 tsp palm oil','crayfish, seasoning, salt, pepper'],
    steps:[
      'Make small amala from 60g plantain flour — one small portion.',
      'Blend or break down ewedu. Cook with water, crayfish, seasoning, 1 tsp oil.',
      'Grill fish separately with spices.',
      'Serve: amala + ewedu + grilled fish.',
    ],
    healthNote:'Plantain flour (elubo) has more fiber than cassava-based swallows. Ewedu is a superfood — mucilaginous, anti-inflammatory.',
  },
  {
    id:'h35', name:'Couscous + Grilled Fish + Vegetables', emoji:'🍽️', category:'Healthy & Diet',
    dietTags:['weight-loss','high-protein','low-calorie'],
    calories:340, protein:30, carbs:38, fat:7, servings:2, cookTime:20, difficulty:'Easy',
    cost:4500,
    ingredients:['couscous 100g (₦800)','1 medium grilled tilapia (₦1,500)','carrots, cabbage, green beans (₦800)','lemon, olive/vegetable oil (1 tsp)','salt, pepper, herbs'],
    steps:[
      'Pour boiling water over couscous. Cover and rest 5 minutes. Fluff with fork.',
      'Season fish with herbs and grill 12 minutes.',
      'Steam or stir-fry vegetables with 1 tsp oil.',
      'Plate: couscous + vegetables + grilled fish.',
    ],
    healthNote:'Couscous cooks in 5 minutes and has fewer calories than rice. A great alternative for weight loss.',
  },

  // ── Dinner additions ──
  {
    id:'h36', name:'Grilled Turkey + Salad', emoji:'🦃', category:'Healthy & Diet',
    dietTags:['high-protein','low-calorie','keto','weight-loss'],
    calories:260, protein:36, carbs:8, fat:9, servings:2, cookTime:35, difficulty:'Easy',
    cost:5000,
    ingredients:['300g turkey breast (₦3,000)','cabbage shredded (₦500)','carrots (₦300)','cucumber (₦500)','lemon juice, 1 tsp oil','salt, thyme, garlic'],
    steps:[
      'Season turkey breast with thyme, garlic, salt, and lemon. Grill 25–30 minutes.',
      'Shred cabbage, slice carrots and cucumber.',
      'Dress salad with lemon juice and oil.',
      'Slice turkey. Serve over salad.',
    ],
    healthNote:'Turkey breast is one of the leanest proteins available in Nigeria. High protein, very low fat — perfect dinner.',
  },
  {
    id:'h37', name:'Chicken Stir Fry + Cabbage', emoji:'🍗', category:'Healthy & Diet',
    dietTags:['high-protein','low-calorie','keto','weight-loss'],
    calories:240, protein:30, carbs:12, fat:8, servings:2, cookTime:20, difficulty:'Easy',
    cost:4000,
    ingredients:['300g chicken breast (₦1,440)','½ cabbage (₦600)','carrots (₦400)','green pepper (₦200)','1 tsp soy sauce','1 tsp vegetable oil','garlic, ginger, seasoning'],
    steps:[
      'Slice chicken thin. Marinate with soy sauce, garlic, ginger, seasoning for 10 minutes.',
      'Stir-fry chicken in 1 tsp oil on high heat until cooked.',
      'Add vegetables. Toss 4–5 minutes on high heat. Keep crunchy.',
      'Serve alone as a complete meal.',
    ],
    healthNote:'No rice, no swallow needed. High-protein, low-carb dinner that comes together in 20 minutes.',
  },
  {
    id:'h38', name:'Pepper Soup (Goat/Chicken) — Dinner', emoji:'🌶️', category:'Healthy & Diet',
    dietTags:['high-protein','low-calorie','weight-loss','diabetic'],
    calories:190, protein:28, carbs:5, fat:7, servings:2, cookTime:45, difficulty:'Easy',
    cost:6000,
    ingredients:['400g goat meat or chicken (₦3,000)','pepper soup spice (₦400)','uziza leaves (₦400)','scotch bonnet, onion, crayfish','seasoning, salt'],
    steps:[
      'Season meat with onion, seasoning, salt, half the pepper soup spice.',
      'Steam 10 minutes, then add water and cook 25–30 minutes.',
      'Add scotch bonnets, crayfish, remaining spice.',
      'Simmer 10 minutes. Add uziza. Serve hot — no side needed.',
    ],
    healthNote:'Pepper soup for dinner is one of the smartest weight-loss habits. Under 200 calories, very filling, promotes good sleep.',
  },
  {
    id:'h39', name:'Steamed Vegetables + Grilled Chicken', emoji:'🥦', category:'Healthy & Diet',
    dietTags:['high-protein','low-calorie','keto','diabetic','weight-loss'],
    calories:210, protein:30, carbs:10, fat:6, servings:2, cookTime:25, difficulty:'Easy',
    cost:4000,
    ingredients:['300g chicken breast (₦1,440)','cabbage (₦500)','carrots (₦400)','green beans (₦400)','lemon, garlic, thyme','1 tsp vegetable oil','salt, pepper'],
    steps:[
      'Season chicken with garlic, thyme, lemon, salt. Grill 15 minutes.',
      'Steam cabbage, carrots, and green beans for 5–6 minutes — keep firm.',
      'Drizzle vegetables with lemon juice and a tiny oil.',
      'Plate: vegetables + sliced grilled chicken.',
    ],
    healthNote:'The cleanest possible dinner. High protein, micronutrient-dense, anti-inflammatory. This is what fat loss looks like.',
  },
  {
    id:'h40', name:'Lettuce Wrap + Tuna', emoji:'🌯', category:'Healthy & Diet',
    dietTags:['high-protein','low-calorie','keto','weight-loss'],
    calories:180, protein:26, carbs:5, fat:6, servings:2, cookTime:5, difficulty:'Easy',
    cost:2500,
    ingredients:['1 tin tuna in brine (₦1,500)','large cabbage leaves (substitute for lettuce) (₦400)','tomatoes, cucumber (₦400)','lemon juice, salt, pepper'],
    steps:[
      'Drain tuna completely.',
      'Mix with diced tomatoes, cucumber, lemon juice, salt, and pepper.',
      'Spoon tuna mixture onto large cabbage leaves.',
      'Roll up and eat immediately. Quick, clean, and filling.',
    ],
    healthNote:'Cabbage leaves work perfectly as a lettuce substitute. This wrap is nearly zero carbs with 26g protein per serving.',
  },
  {
    id:'h41', name:'Efo Riro + Small Swallow', emoji:'🥬', category:'Healthy & Diet',
    dietTags:['high-protein','high-fiber','weight-loss'],
    calories:310, protein:22, carbs:32, fat:10, servings:2, cookTime:40, difficulty:'Easy',
    cost:4500,
    ingredients:['500g fresh spinach (₦600)','200g assorted meat (₦2,000)','1 tbsp palm oil (reduced)','locust beans, crayfish, peppers (₦800)','60g semovita for small swallow (₦400)'],
    steps:[
      'Make efo riro: fry peppers in 1 tbsp oil, add meat, crayfish, locust beans.',
      'Add spinach last — cook 3 minutes only.',
      'Make a small portion of swallow from just 60g semovita.',
      'Serve generous soup with small swallow.',
    ],
    healthNote:'Efo riro is the most nutritious Yoruba soup. Iron, vitamins, antioxidants. Keep the swallow small and enjoy more soup.',
  },
  {
    id:'h42', name:'Boiled Sweet Potato + Grilled Fish', emoji:'🍠', category:'Healthy & Diet',
    dietTags:['high-fiber','weight-loss','diabetic','high-protein'],
    calories:270, protein:24, carbs:32, fat:5, servings:2, cookTime:30, difficulty:'Easy',
    cost:3500,
    ingredients:['2 medium sweet potatoes (₦1,500)','2 small tilapia or mackerel (₦1,500)','lemon, thyme, garlic, salt','1 tsp vegetable oil'],
    steps:[
      'Boil sweet potatoes until fork-tender, 20 minutes.',
      'Season fish with herbs, lemon, salt. Grill 12 minutes.',
      'Serve sliced sweet potato with grilled fish.',
      'Add a side of cucumber or tomato slices.',
    ],
    healthNote:'Sweet potato + fish is a near-perfect weight-loss dinner. Low glycemic, high protein, rich in beta-carotene and omega-3.',
  },

  // ── Snacks additions ──
  {
    id:'h43', name:'Greek Yogurt + Watermelon', emoji:'🍉', category:'Healthy & Diet',
    dietTags:['low-calorie','weight-loss','high-protein'],
    calories:140, protein:10, carbs:18, fat:2, servings:1, cookTime:2, difficulty:'Easy',
    cost:1000,
    ingredients:['¾ cup Greek yogurt (₦500)','2 slices watermelon (₦300)','optional: mint leaves'],
    steps:[
      'Scoop Greek yogurt into a bowl.',
      'Cut watermelon into cubes and place alongside.',
      'Optional: add fresh mint leaves for freshness.',
      'Eat together or alternate bites — yogurt balances watermelon sweetness.',
    ],
    healthNote:'Watermelon is 92% water — very filling for its calories. Greek yogurt adds protein. Together: a 5-minute high-protein snack.',
  },
  {
    id:'h44', name:'Roasted Groundnuts (Small Portion)', emoji:'🥜', category:'Healthy & Diet',
    dietTags:['high-protein','keto','weight-loss'],
    calories:160, protein:7, carbs:5, fat:13, servings:1, cookTime:1, difficulty:'Easy',
    cost:300,
    ingredients:['30g roasted groundnuts (₦300)'],
    steps:[
      'Portion out 30g of roasted groundnuts — about a small handful.',
      'Eat slowly. Do not eat from the bag — portion first.',
      'Pair with water or unsweetened zobo.',
    ],
    healthNote:'30g of groundnuts = 7g protein, healthy fats, very filling. The key is portion control — stop at one handful.',
  },
  {
    id:'h45', name:'Boiled Eggs (Snack)', emoji:'🥚', category:'Healthy & Diet',
    dietTags:['high-protein','keto','weight-loss','diabetic','low-calorie'],
    calories:140, protein:12, carbs:1, fat:10, servings:1, cookTime:10, difficulty:'Easy',
    cost:260,
    ingredients:['2 eggs (₦260)','salt, pepper optional'],
    steps:[
      'Place eggs in cold water. Bring to boil.',
      'Hard boil: 10 minutes. Medium: 7 minutes. Soft: 5 minutes.',
      'Cool in cold water. Peel and eat.',
      'Season with salt and pepper. Simple and filling.',
    ],
    healthNote:'The perfect snack. 6g protein per egg, only 70 calories, zero carbs. Boiled eggs stop cravings better than almost anything else.',
  },
  {
    id:'h46', name:'Tiger Nuts (Small Portion)', emoji:'🌰', category:'Healthy & Diet',
    dietTags:['high-fiber','weight-loss','diabetic'],
    calories:120, protein:2, carbs:22, fat:4, servings:1, cookTime:1, difficulty:'Easy',
    cost:300,
    ingredients:['30g dried tiger nuts (₦300)'],
    steps:[
      'Portion 30g tiger nuts into a small bowl.',
      'Eat slowly — they are chewy and require real chewing.',
      'Great with water or tiger nut milk.',
    ],
    healthNote:'Tiger nuts are one of the most fiber-rich snacks in Nigeria. Traditionally linked to digestive health and blood sugar control.',
  },
  {
    id:'h47', name:'Unsweetened Zobo Drink', emoji:'🥤', category:'Healthy & Diet',
    dietTags:['low-calorie','diabetic','weight-loss'],
    calories:15, protein:0, carbs:3, fat:0, servings:4, cookTime:20, difficulty:'Easy',
    cost:500,
    ingredients:['2 cups dried zobo (hibiscus) petals (₦300)','4 cups water','ginger slices (₦100)','cloves (optional)','NO sugar'],
    steps:[
      'Rinse zobo petals. Add to pot with water, ginger, and cloves.',
      'Boil 15 minutes. The water turns deep red.',
      'Strain. Allow to cool. Refrigerate.',
      'Serve chilled with NO added sugar. Naturally slightly tart.',
    ],
    healthNote:'Zobo without sugar has only 15 calories per cup. Rich in antioxidants and Vitamin C. Shown to lower blood pressure naturally.',
  },
  {
    id:'h48', name:'Cucumber + Carrot Sticks', emoji:'🥕', category:'Healthy & Diet',
    dietTags:['low-calorie','weight-loss','vegetarian','diabetic','keto'],
    calories:50, protein:2, carbs:10, fat:0, servings:1, cookTime:5, difficulty:'Easy',
    cost:400,
    ingredients:['1 cucumber (₦200)','2 medium carrots (₦200)','lemon juice, salt optional'],
    steps:[
      'Wash and peel cucumber. Cut into sticks.',
      'Peel carrots. Cut into sticks.',
      'Arrange on a plate. Squeeze lemon juice. Sprinkle salt.',
      'Eat as a snack or alongside any meal.',
    ],
    healthNote:'The ultimate zero-guilt snack. Cucumber is 96% water. Carrots add beta-carotene. Under 50 calories for a generous portion.',
  },
  {
    id:'h49', name:'Peanut Butter (1 Spoon) + Apple', emoji:'🍎', category:'Healthy & Diet',
    dietTags:['high-protein','high-fiber','weight-loss'],
    calories:190, protein:5, carbs:22, fat:10, servings:1, cookTime:2, difficulty:'Easy',
    cost:800,
    ingredients:['1 tbsp natural peanut butter (₦400)','1 medium apple (₦400)'],
    steps:[
      'Slice apple into wedges.',
      'Dip each wedge into peanut butter.',
      'Eat slowly and enjoy the combination.',
      'Use natural peanut butter only — no added sugar or oil.',
    ],
    healthNote:'Apple + peanut butter = fiber + healthy fat + protein. One of the most satisfying snacks for weight loss. Stops sugar cravings.',
  },
  {
    id:'h50', name:'Fruit Salad (No Sugar Added)', emoji:'🍓', category:'Healthy & Diet',
    dietTags:['low-calorie','weight-loss','vegetarian','diabetic'],
    calories:120, protein:2, carbs:28, fat:1, servings:2, cookTime:5, difficulty:'Easy',
    cost:1000,
    ingredients:['watermelon (₦300)','banana (₦200)','pineapple (₦300)','orange (₦200)','lemon juice to dress'],
    steps:[
      'Dice all fruits into bite-sized pieces.',
      'Combine in a bowl.',
      'Squeeze lemon juice over — this is the only dressing.',
      'No sugar, no cream, no condensed milk. Serve chilled.',
    ],
    healthNote:'Natural fruit sugars come with fiber which slows absorption. Completely different from adding sugar. A perfect dessert or snack.',
  },
];
